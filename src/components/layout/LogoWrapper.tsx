...
export function LogoWrapper() {
  ...
  return (
    <Link href="/" className="fixed top-3 left-3 z-[90] group" aria-label="Ashiqa's Design Studio — Home">
      <span className="inline-flex items-center justify-center h-[165px] w-[165px] rounded-md p-1 bg-ash-off-white/90 ring-1 ring-border shadow-sm">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/LOGO.png"
          alt="Ashiqa's Design Studio"
          className="h-[140px] w-auto transition-opacity duration-300 group-hover:opacity-90"
