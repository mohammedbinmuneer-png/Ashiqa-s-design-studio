  ...
  return (
    <AnimatePresence>
      {phase !== "done" && (
        ...
        >
          {/* Ambient glow */}
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(243,110,66,0.08)_0%,transparent_55%)]" />
          ...
          >
            <p className="text-[11px] uppercase tracking-[0.45em] text-white/35 font-sans">
              Loading
            </p>
