        ...
        <div className="bg-white rounded-[2rem] p-8 md:p-14 lg:p-20 shadow-sm space-y-12 md:space-y-16">
          ...
          >
            ...
            <div className="space-y-6 lg:pt-2">
              <p className="text-[#3F3F46] text-sm sm:text-base leading-relaxed max-w-md lg:ml-auto lg:text-right">
              ...
              <div className="flex lg:justify-end">
                ...
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-full border border-[#CEC8BA] group-hover:border-primary group-hover:bg-primary/5 transition-colors">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2rem] aspect-[16/9] md:aspect-[21/9] bg-[#EBE9E4]"
          >
            <img
